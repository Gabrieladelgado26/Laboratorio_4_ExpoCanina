...
@WebServlet(name = "SvExpoCanina", urlPatterns = {"/SvExpoCanina"})
public class SvExpoCanina extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SvExpoCanina</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SvExpoCanina at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Crear un objeto
        Perro miPerro = new Perro(nombre, raza, imagen, Integer.parseInt(puntos), Integer.parseInt(edad));
